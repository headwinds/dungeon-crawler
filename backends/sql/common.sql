...
CREATE TABLE social (
  ...
  social_app varchar(255) NOT NULL,
...
INSERT INTO social (social_app, token, colonist_id) VALUES
  ('twitter', '123', 5);

-- check if social exists
-- note has to be single quotes! double quotes doesnt work

SELECT * FROM social WHERE colonist_id = 5 and social_app = 'twitter';
